...
void analytic_MCP::background_binance_oprator::binance_startup()
   {
  ...
  void analytic_MCP::background_binance_oprator::operator()()
  { 
    binance_startup();
  ...
  void analytic_MCP::background_binance_oprator::update_prices()
  {
...
void analytic_MCP::cycle_prices_alerts_redux()
	{
	...
	void analytic_MCP::threshold_crossed(threshold_price* thresh_point, long t)
	{
		thresh_point->count++;
	...
	void analytic_MCP::check_above_and_update(double pp,long t, threshold_price* thresh_point)
	{
...
void analytic_MCP::cycle_price_roofs(long t)
{
...
bool analytic_MCP::is_price_above_threshold(double price, double thresh)
{
	if (price > thresh)
	{	
		return true;
...
bool analytic_MCP::is_price_bellow_threshold(double price, double thresh)
{
	if (price < thresh)
	{
		return true;
...
void analytic_MCP::cycle_price_floors(long t)
{
