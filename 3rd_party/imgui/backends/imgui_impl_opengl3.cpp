...
bool    ImGui_ImplOpenGL3_CreateDeviceObjects()
{
    ...
    else if (glsl_version > 420)
    {
        vertex_shader = vertex_shader_glsl_450_core;
        fragment_shader = fragment_shader_glsl_450_core;
    }
    else if (glsl_version >= 410 && glsl_version< 430)
    {
